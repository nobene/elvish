...
var (
	vscrollbarThumb  = ui.T(" ", ui.FgBrightBlack, ui.Inverse)
	vscrollbarTrough = ui.T("│", ui.FgBrightBlack)
)
...
var (
	hscrollbarThumb  = ui.T(" ", ui.FgBrightBlack, ui.Inverse)
	hscrollbarTrough = ui.T("━", ui.FgBrightBlack)
)
